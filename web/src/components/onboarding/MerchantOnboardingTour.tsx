...
const STEPS: Step[] = [
  {
    ...
    kicker: 'Welcome',
    title: '获客智能体',
    lead: '帮老板用账号 IP 持续获客——按「建人设 → 出内容 → 发出去 → 看线索」四步走完闭环。',
  },
  {
    target: 'merchant-nav',
    placement: 'right',
    kicker: 'Flow',
    title: '四步闭环在侧栏',
    lead: '建人设 → 出内容 → 发出去 → 看线索，从上到下就是主流程，顺序清晰也可随时折返。',
  },
  {
    target: 'merchant-search',
    placement: 'bottom',
    kicker: 'Search',
    title: '全局搜索',
    lead: 'Ctrl K 唤起，人设、作品与发布任务都能直接搜到。',
  },
  {
    target: 'merchant-cta',
    placement: 'bottom',
    kicker: 'Create',
    title: '一键开拍',
    lead: '点「立即创作」进入口播向导：写脚本 → 配素材 → 出成片，写好的稿子自动带过去。',
    cta: '开始使用',
  },
]
