...
// MilvusVectorStore 占位（Milvus 运行时再实现，当前用 Nop 降级）
// 后续接入：go get github.com/milvus-io/milvus-sdk-go/v2
...
func NewMilvusVectorStore(host, port string) (*MilvusVectorStore, error) {
	// TODO: 接入真实 Milvus SDK
	// 当前降级为 Nop，不阻塞业务
	return &MilvusVectorStore{nopFallback: &nopFallback{}}, nil
}
